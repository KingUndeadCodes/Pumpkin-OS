# Makefile: https://github.com/KingUndeadCodes/Pumpkin-OS/blob/main/etc/Makefile
#!/bin/bash
function build {
    clear
    ...
    i386-elf-ld -o kernel.bin -Ttext 0x1000 Kernel-Entry.o kernel.o text.o idt.o isr.o irq.o kb.o string.o speaker.o --oformat binary
    ...
    rm isr.o image.bin kb.o Kernel-Entry.o kernel.bin Pump.bin kernel.o text.o idt.o irq.o empty_end.bin short.bin string.o speaker.o
    echo -e " done"
